// - Ejemplos de acciones (JSON escapado con doble llaves para TypeScript):

// "{{\"action\": \"get_products\", \"query\": [\"pantalones\",\"pantalón\",\"jeans\"]}}"
// "{{\"action\": \"get_product\", \"product_id\": \"12\"}}"
// "{{\"action\": \"create_cart\", \"items\": [{{\"product_id\": \"12\", \"quantity\": 2}}]}}"
// "{{\"action\": \"update_cart\", \"cart_id\": \"5\", \"items\": [{{\"product_id\": \"12\", \"quantity\": 2}}]}}"
...
//   - Antes de ejecutar "get_products", **debes generar un array de términos expandidos** (5 sinónimos, plurales o categorías relevantes) en el parámetro "query" para la búsqueda.
//   - Ejemplos de query en "get_products":
// "{{\"query\": [\"pantalones\",\"pantalón\",\"jeans\"]}}"
